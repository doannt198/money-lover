...
import './index.css'
class TroGiup extends Component {
    render() {
        return (
          <div className="faq">
            <div className="faq-wrapper">
              <div className="faq-header">
                ...
                <div className="header-body">
                  ...
                  <span>
                    Get the most our of software. Contact us if you don't find
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <label htmlFor="android">
                      <img
                        src="./assets/faq/rsz_android-home.png"
                        alt="Android"
                      />
                      <span>Android</span>
                    </label>
                  ...
                  <li>
                    ...
                    <label htmlFor="window">
                      <img
                        src="./assets/faq/rsz_windows-home.png"
                        alt="Windows"
                      />
                      <span>Windows</span>
                    </label>
                  ...
                  <li>
                    ...
                    <label htmlFor="window-phone">
                      <img
                        src="./assets/faq/rsz_windowphone-home.png"
                        alt="Windowphone"
                      />
                ...
                <div className="faq-content-group">
                  ...
                  <div className="faq-item">
                    ...
                    <div className="content">
                      ...
                      <p>
                        4. Bill reminders &amp; schedule for recurring
                        transactions..
                      </p>
                      <p>
                        5. Travel mode for tourists. You can see more user guide
                        blogs at
                        [here](http://note.moneylover.me/hard-to-use-here-are-guides/)
                      </p>
                    </div>
                  </div>
                  <div className="faq-item">
                    ...
                    <div className="content">
                      <p>
                        Yes, in case you registered Money Lover account. You
                        only need to login in other devices to continue use
                        Money Lover.
                      </p>
                      <p>
                        We support Android, iOS, Windows Phone, Windows 8.1, 10;
                        MacOS and Web-based.
                      </p>
                      <p>
                        Cloud service makes Money Lover work seamlessly across
                        all devices.
                      </p>
                      <p>Android : phone and tablet.</p>
                      <p>iOS : iPhone, iPad and iPod</p>
                      <p>
                        Windows : Windows 8.1, Windows 10 and Windows phone.
                      </p>
                      <p>Mac OS : testing</p>
                  ...
                  <div className="faq-item">
                    ...
                    <div className="content">
                      <p>
                        We can't support for these options. Sorry for this
                        inconvenience.
                      </p>
                    </div>
                  </div>
